  ...
  const renderItem = (index: number) => {
    ...
    return (
      <div
        ...
        key={index}
      >
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 justify-center">
          {DATA.map((_, index) => {
            const isActive = indexActive === index;
            return (
              <div
              ...
              >
                <div
                  className={`relative w-20 h-1 shadow-sm rounded-md bg-light`}
                >
                  {isActive && (
                    <div
        ...
        {/* BG */}
        <div className="absolute inset-0 bg-[#af95a27c]">
          <Image
            fill
